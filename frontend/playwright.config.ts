...
const requiredE2eVariables = [
  ...
  'E2E_INVENTORY_PRODUCT_CODE',
  'E2E_INVENTORY_PRODUCT_DESCRIPTION',
  'E2E_INVENTORY_SOURCE_WAREHOUSE_CODE',
  'E2E_INVENTORY_SOURCE_WAREHOUSE_NAME',
  'E2E_INVENTORY_DESTINATION_WAREHOUSE_CODE',
  'E2E_INVENTORY_DESTINATION_WAREHOUSE_NAME',
  'E2E_INVENTORY_TRANSFER_REFERENCE',
  'VITE_SUPABASE_URL',
