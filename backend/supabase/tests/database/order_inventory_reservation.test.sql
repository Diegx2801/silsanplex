...
insert into public.products (
  ...
  ('b2e00000-0000-4000-8000-000000000001', 'b2b00000-0000-4000-8000-000000000001', 'ORD-001', 'Producto FEFO multilote', 'UND', 'gravado', true, true, 'b2c00000-0000-4000-8000-000000000001', 'b2c00000-0000-4000-8000-000000000001'),
  ('b2e00000-0000-4000-8000-000000000002', 'b2b00000-0000-4000-8000-000000000001', 'ORD-002', 'Producto simple', 'UND', 'gravado', false, false, 'b2c00000-0000-4000-8000-000000000001', 'b2c00000-0000-4000-8000-000000000001'),
  ('b2e00000-0000-4000-8000-000000000003', 'b2b00000-0000-4000-8000-000000000001', 'ORD-003', 'Producto multilinea', 'UND', 'gravado', false, false, 'b2c00000-0000-4000-8000-000000000001', 'b2c00000-0000-4000-8000-000000000001'),
  ('b2e00000-0000-4000-8000-000000000004', 'b2b00000-0000-4000-8000-000000000001', 'ORD-004', 'Producto reserva parcial', 'UND', 'gravado', false, false, 'b2c00000-0000-4000-8000-000000000001', 'b2c00000-0000-4000-8000-000000000001'),
  ('b2e00000-0000-4000-8000-000000000005', 'b2b00000-0000-4000-8000-000000000001', 'ORD-005', 'Producto lote vencido', 'UND', 'gravado', true, true, 'b2c00000-0000-4000-8000-000000000001', 'b2c00000-0000-4000-8000-000000000001'),
  ('b2e00000-0000-4000-8000-000000000006', 'b2b00000-0000-4000-8000-000000000001', 'ORD-006', 'Producto cuarentena', 'UND', 'gravado', true, true, 'b2c00000-0000-4000-8000-000000000001', 'b2c00000-0000-4000-8000-000000000001'),
  ('b2e00000-0000-4000-8000-000000000007', 'b2b00000-0000-4000-8000-000000000001', 'ORD-007', 'Producto danado', 'UND', 'gravado', true, true, 'b2c00000-0000-4000-8000-000000000001', 'b2c00000-0000-4000-8000-000000000001'),
  ('b2e00000-0000-4000-8000-000000000008', 'b2b00000-0000-4000-8000-000000000001', 'ORD-008', 'Producto insuficiente A', 'UND', 'gravado', false, false, 'b2c00000-0000-4000-8000-000000000001', 'b2c00000-0000-4000-8000-000000000001'),
  ('b2e00000-0000-4000-8000-000000000009', 'b2b00000-0000-4000-8000-000000000001', 'ORD-009', 'Producto insuficiente B', 'UND', 'gravado', false, false, 'b2c00000-0000-4000-8000-000000000001', 'b2c00000-0000-4000-8000-000000000001');

insert into public.products (
  id, organization_id, code, description, unit_of_measure,
  tax_affectation, batch_control, expiration_control, created_by, updated_by
) values (
  'b2e00000-0000-4000-8000-000000000010', 'b2b00000-0000-4000-8000-000000000002', 'OTR-010', 'Producto otra organizacion', 'UND', 'gravado', false, false, 'b2c00000-0000-4000-8000-000000000002', 'b2c00000-0000-4000-8000-000000000002'
);
