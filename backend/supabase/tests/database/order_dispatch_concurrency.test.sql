...
insert into public.products (id, organization_id, code, description, unit_of_measure, tax_affectation, created_by, updated_by) values
  ('b4e00000-0000-4000-8000-000000000001', 'b4b00000-0000-4000-8000-000000000001', 'DSP-CONC', 'Producto despacho concurrente', 'UND', 'gravado', 'b4c00000-0000-4000-8000-000000000001', 'b4c00000-0000-4000-8000-000000000001');
